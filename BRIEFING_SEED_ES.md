...
| `STORY_A1.md` | Bíblia narrativa — lore, arco das 5 temporadas, personagens universais |
| `CHARACTERS_A1.md` | Perfis completos de todos os personagens — **leia com atenção o Miguel** |
| `INVENTORY_SYSTEM.md` | Sistema de Mochila, itens, word→item |

---

## 2. Contexto da sessão anterior — o que foi decidido

### Miguel foi atualizado (CHARACTERS_A1.md já reflete isso)
...
- Não hardcodar texto de UI nos seeds — o seed é conteúdo narrativo, não strings
  de interface
- Não alterar `STORY_A1.md` ou `CHARACTERS_A1.md` sem consultar o usuário —
