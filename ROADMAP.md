...
- [ ] HomeScreen redesenhada (prompt já gerado em DESIGN_SYSTEM_CONTEXT.md)
...
Inventário, poderes, magias, sistema de atributos — isso é semana 2+. Está documentado em `GAME_CONCEPT.md`. Não vai sumir.
...
Documentado em `GAME_CONCEPT.md`:
