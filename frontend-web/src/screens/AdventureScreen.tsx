          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-[10px] font-bold uppercase tracking-wide" style={{ color: c.goldAccent }}>
                {activePhase.is_boss
                  ? `⚔️ Boss · ${activeChapter.level}`
                  : activePhase.phase_type === "review"
                  ? `📚 Revisão · ${activeChapter.level}`
                  : `Próxima fase · ${activeChapter.level}`}
              </p>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {isUnlocked && TITLE_PT[ch.slug] && (
                      <p className="truncate text-xs font-medium mt-0.5" style={{ color: `${c.parchment}50` }}>
                        {TITLE_PT[ch.slug]}
                      </p>
                    )}
                    {isUnlocked && (
